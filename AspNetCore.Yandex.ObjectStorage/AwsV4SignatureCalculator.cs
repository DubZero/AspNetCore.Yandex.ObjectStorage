...
namespace AspNetCore.Yandex.ObjectStorage
{
    public class AwsV4SignatureCalculator
    {
        ...
        public static async Task<string> GetPayloadHashAsync(HttpRequestMessage request)
        {
        ...
        /// <returns></returns>
        private static async Task<string> GetCanonicalRequestAsync(HttpRequestMessage request, string[] signedHeaders)
        {
            ...
            canonicalRequest.Append(await GetPayloadHashAsync(request));
