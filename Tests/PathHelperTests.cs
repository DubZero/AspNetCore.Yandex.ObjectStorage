...
namespace Tests
{
	...
	{
		public const string SimpleUrl = "https://storage.yandexcloud.net/test/23D919258BF03F640BB745274F41A1BF.pdf";
		public const string WithPathUrl = "https://storage.yandexcloud.net/test/path1/23D919258BF03F640BB745274F41A1BF.pdf";
		public const string HardWithPathUrl = "https://storage.yandexcloud.net/test/test/23D919258BF03F640BB745274F41A1BF.pdf";
		...
		public void TestMultipleBucketNames()
		{
			...
			var index1 = url.IndexOfFile();
			Assert.AreEqual("test".Length, index1, "Wrong index of File (HardWithPathUrl)");
		}
